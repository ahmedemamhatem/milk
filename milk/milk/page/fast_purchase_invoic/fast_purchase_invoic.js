	...
	const ui_html = `
		<div class="fast-pi-full">
			<style>
				...
				.fastpi-title { font-size: 22px; font-weight: 800; letter-spacing: .2px; }
				.fastpi-status { font-size: 12px; color: var(--muted); }

				.fastpi-sections { max-width: 1280px; margin: 0 auto; }
				.section { border-bottom: 1px solid var(--line); padding: 6px 0 10px; }
				...
				.kv .v { font-size: 18px; font-weight: 800; color: var(--text); }
